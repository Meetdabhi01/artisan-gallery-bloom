...
const portfolioItems = [
  ...
  },
  {
    ...
    description:
      "Beautifully crafted macramé wall hangings and planters made from sustainable materials.",
    image:
      "https://img.freepik.com/free-photo/traditional-macrame-composition-indoors_23-2149072857.jpg?t=st=1746805901~exp=1746809501~hmac=5893290bdd78c9b314173cc33a0d9da477a102247eb4da7beffe8153ed572669&w=740",
  },
  {
    id: "p3",
    title: "Artisanal Candle Collection",
    description:
      "Hand-poured soy wax candles with carefully selected natural scents and minimal packaging.",
    image:
  ...
  },
  {
    ...
    description:
      "Hand-embroidered textile pieces featuring modern abstract designs and traditional techniques.",
    image:
  ...
  },
  {
    ...
    description:
      "Original watercolor paintings featuring serene landscapes and nature-inspired scenes.",
    image:
  ...
  },
  {
    ...
    description:
      "Traditionally crafted baskets using sustainable reed and natural dyeing techniques.",
    image:
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8 animate-fade-in">
          <h2 className="text-3xl md:text-4xl font-serif font-medium mb-4">
            Our <span className="font-playfair italic">Portfolio</span>
          </h2>
          <p className="text-zinc-600 font-sans">
            Explore our collection of handcrafted artworks
          </p>
        </div>
              ...
              >
                <CardContent className="p-0">
                  ...
                  <div className="p-4 group">
                    <h3 className="font-playfair text-lg font-medium transition-transform group-hover:translate-x-1 duration-300">
                      {item.title}
                    </h3>
                  </div>
                </CardContent>
      ...
      >
        <DialogContent className="max-w-3xl w-[90vw] animate-fade-in">
          <div className="grid md:grid-cols-2 gap-4">
            <div
              className="aspect-square overflow-hidden rounded-md animate-scale-in"
            ...
            <div
              className="flex flex-col justify-center p-2 animate-fade-in"
              style={{ animationDelay: "0.2s" }}
            >
              <h3 className="text-2xl font-playfair font-medium mb-2">
                {selectedItem?.title}
              </h3>
              <p className="text-zinc-600 mb-4 font-sans">
